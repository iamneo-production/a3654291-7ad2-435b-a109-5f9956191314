...
(async () => {
  ...
  try{
    await page.goto('https://8081-aaafeabafbaeebfcbdfffdcfebaeceaec.project.examly.io/');
  ...
  try{
    await page1.goto('https://8081-aaafeabafbaeebfcbdfffdcfebaeceaec.project.examly.io/');
  ...
  try{
    await page2.goto('https://8081-aaafeabafbaeebfcbdfffdcfebaeceaec.project.examly.io/');
  ...
  try{
    await page3.goto('https://8081-aaafeabafbaeebfcbdfffdcfebaeceaec.project.examly.io/');
